...
export class AngularComponent {
  // items = [{title:'1. Angular Fundamentals', description: [
  //   'Angular CLI and Project Structure',
  //   'Modules, Components, and Templates',

  // ]},
  //   {title:'2. TypeScript Essentials', description: 'Lorem Ipsumm'},
  //   {title:'3. Component Interaction', description: 'Lorem Ipsumm'},
  //   {title:'4. Routing and Navigation', description: 'Lorem Ipsumm'},
  //   {title:'5. Forms', description: 'Lorem Ipsumm'},
  //   {title:'6. HTTP and APIs', description: 'Lorem Ipsumm'},
  //   {title:'7. State Management', description: 'Lorem Ipsumm'},
  //   {title:'8. Change Detection and Performance', description: 'Lorem Ipsumm'},
  //   {title:'9. Testing', description: 'Lorem Ipsumm'},
  //   {title:'10. Styling and Theming', description: 'Lorem Ipsumm'},
  //   {title:'11. Advanced Angular 20 Features', description: 'Lorem Ipsumm'},
  //   {title:'12. Best Practices and Tooling', description: 'Lorem Ipsumm'},
  //   {title:'13. Migration and Upgrading', description: 'Lorem Ipsumm'}
  // ];
  items = [
  {
